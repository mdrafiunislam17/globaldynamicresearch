                    ...
                    <main class="site-main" id="main">
                        ...
                        <article class="post-6677 page type-page status-publish hentry" id="post-6677">
                            ...
                            <header class="entry-header">
                                ...
                                <h3 class="entry-title">{{$conference->title}}</h3>
                            </header><!-- .entry-header -->
                            ...
                            <div class="entry-content">
                                ...
                                @if (!empty($conference->image) && file_exists(public_path("uploads/training/$conference->image")))
                                    <img src="{{ asset("uploads/training/$conference->image") }}" alt="Training Image">
                                @endif
