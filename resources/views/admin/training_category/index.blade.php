...
@section("content")
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Training Category</h1>
            <a href="{{ route("training-categories.create") }}"
               class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                    class="fas fa-plus fa-sm text-white-50"></i> Create Training Categorys</a>
        </div>
                        ...
                        @foreach( $categories as $i => $categorie)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route("training-categories.edit", $categorie->id) }}" class="btn btn-sm btn-warning"><i
                                            class="fa fa-edit"></i></a>
                                    <form action="{{ route('training-categories.destroy', $categorie->id) }}" method="post" class="d-inline delete-form" data-id="{{ $categorie->id }}">
                                        @csrf
                                        @method('DELETE')
