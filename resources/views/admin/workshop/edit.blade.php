...
@section("content")
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Edit Workshop</h1>
            <a href="{{ route('workshop.index') }}"
               class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                <i class="fas fa-eye fa-sm text-white-50"></i> View Workshops
            </a>
        </div>
                ...
                <form action="{{ route('workshop.update', $workshop->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="time"
                                   ...
                                   id="end_time"
                                   name="end_time"
                                   value="{{ old('end_time', $workshop->end_time) }}"
                                   required>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <textarea name="description"
                                  id="description"
                                  class="form-control"
                                  rows="5">{{ old('description', $workshop->description) }}</textarea>
                        </div>
                    </div>
                    ...
                    @if ($workshop->image)
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <img src="{{ asset('uploads/workshop/' . $workshop->image) }}"
                                     alt="Workshop Image"
                                     class="img-thumbnail"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <select name="status" id="status" class="form-control">
                                <option value="1" {{ old('status', $workshop->status) == 1 ? 'selected' : '' }}>Active</option>
                                <option value="0" {{ old('status', $workshop->status) == 0 ? 'selected' : '' }}>Inactive</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="offset-sm-3 col-sm-6">
                            <button type="submit" class="btn btn-success">
                                <i class="fas fa-save mr-1"></i> Update Workshop
                            </button>
                        </div>
                    </div>
